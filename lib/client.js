window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function CalendarHeatmap({ from, to, days, totalCost, peak, t, formatCost, formatTokens }) {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							peak === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								children: `${t("peakDay")} ${peak.day} · ${formatCost(peak.cost)}`
							})
						]
					}),
					hover === void 0 ? null : (0, react_dom.createPortal)(/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("totalTokens") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: formatTokens(tokensOf$1(hover.row)) })] }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("inputTokens") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: formatTokens(hover.row.uncachedInputTokens) })] }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("outputTokens") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: formatTokens(hover.row.outputTokens) })] }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("cacheRead") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: formatTokens(hover.row.cacheReadTokens) })] }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("calls") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: String(hover.row.calls) })] })
							]
						})] })]
					}), document.body)
				]
		...
		*/
		function DataSourceNotes({ report, weeks, t }) {
			const counts = t("dataCounts", {
				count: String(report.scannedSessions),
				unreadable: report.unreadableSessions === 0 ? "" : t("unreadableNote", { count: String(report.unreadableSessions) }),
		...
		function rate(value) {
			if (value === 0) return "0";
			if (value < .01) return String(value);
		...
		function PriceRow({ row, label, currency }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("tr", { children: [
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", {
					...
					children: rate(row.input)
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", {
					className: css.numeric,
					children: rate(row.cacheRead)
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", {
					className: css.numeric,
					children: rate(row.cacheWrite)
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", {
					className: css.numeric,
					children: rate(row.output)
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", {
		...
		* @returns the disclosure block.
		*/
		function PricingNotes({ report, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("summary", {
					...
					children: [
						...
						report.peakWindows.length === 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: schedule }),
		...
		*/
		...
		function costFormatter(currency, digits) {
		...
		function formatCost(value, currency) {
			...
			const digits = magnitude === 0 ? 2 : magnitude < .01 ? 4 : magnitude < 1 ? 3 : 2;
		...
		*/
		function UsagePanel({ panelId, report, t, usePanelInfo }) {
			...
			const money = (value) => formatCost(value, currency);

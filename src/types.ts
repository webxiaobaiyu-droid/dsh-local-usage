...
export const NO_RELIABILITY: UsageReliability = {
  retries: 0,
  retryCauses: [],
  toolCalls: 0,
  toolErrors: 0,
...
export function reliabilityIsEmpty(reliability: UsageReliability): boolean {
  return reliability.retries === 0
    && reliability.toolErrors === 0
    && reliability.compactionFailures === 0
}

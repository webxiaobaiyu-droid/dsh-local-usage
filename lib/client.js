	...
	factory: (require) => {
		...
		*/
		function CalendarHeatmap({ from, to, days, totalCost, peak, t, formatCost, formatInteger, formatDay, onSelectDay, focusDayOnMount }) {
			...
			const renderedDays = (0, react.useMemo)(() => {
				...
				for (const week of grid.slice(-visibleColumns)) for (const cell of week) if (cell !== null) present.add(cell.day);
				return present;
			}, [grid, visibleColumns]);
			...
			*/
			...
			const moveFocus = (event, column, row) => {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									children: Array.from({ length: WEEKDAY_ROWS }, (_, row) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
										...
										role: "row",
										children: visible.map((week, column) => {
											const cell = week[row];
											...
											return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
												...
												onFocus: () => {
													setFocusCell(cell.day);
												},
												onKeyDown: (event) => {
													moveFocus(event, column, row);
												},
												onClick: () => {
		...
		*/
		function UsagePanel({ panelId, locale, report, t, usePanelInfo }) {
			...
			const currency = dayState.status === "ready" ? dayState.report.currency : state.status === "ready" ? state.grid.currency : "CNY";
			...
			const dateText = (value) => formatDay(value, activeLocale);
